...
inline auto get_device_from_object_path(juce::StringRef device_path) -> OrgBluezDevice1*
{
...
inline auto get_device_for_address(const OrgBluezAdapter1* adapter, juce::StringRef device_address) -> OrgBluezDevice1*
{
