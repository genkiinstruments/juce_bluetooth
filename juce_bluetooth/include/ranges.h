...
inline auto property(const juce::Identifier& id) { return [id](const juce::ValueTree& vt) { return vt.getProperty(id); }; }

template<typename T>
inline auto property_as(const juce::Identifier& id) { return [id](const juce::ValueTree& vt) { return static_cast<T>(vt.getProperty(id)); }; }
